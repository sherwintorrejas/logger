...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2023 at 02:59 PM
...
INSERT INTO `tbl_student` (`st_id`, `st_name`, `st_address`, `st_contact`, `st_gender`, `st_date`, `st_in`, `st_out`) VALUES
(54564, 'Creshell Mae Albiso', 'Brgy. Bairan City of Naga, Cebu', '097525646651', 'Female', '0000-00-00', '12:30 Pm', '3:30 Pm'),
(12345440, 'NIEL', 'SITIO.SAMBAG', '0975268206', 'MALE', '0000-00-00', '9:30 AM  ', '10:30PM '),
(12345442, 'Rico Requinto', 'Naga', '09356177614', 'Male', '0000-00-00', '12', '13 ');
...
(66, 'a', 'a', 'a', 's', 'Male', '4.jpg', '$2a$10$PdWe1Cq9Xh2pQHJzGQSuB.XfjlUH5nYCNVTJgtn3xwDMEos3O48lq');
...
--
ALTER TABLE `tbl_student`
  MODIFY `st_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12345443;
